   ...
   <div class="main-textgrids">
				 		<div class="container">
				 			<div class="col-md-5 ab-pic">
				 					<img src="images/2dkr.jpg" alt=" " />

				 			</div>
				 			<div class="col_1_of_2">
				  <h4 class="text-blue title-border mb-30 bars">Biodata Dokter</h4>
								<ul class="ab">
									<li><a>Nama : Anita Natiur Panggabean </a></li>
                                    <li><a>Tanggal Lahir : 22 Mei 1971</a></li>
                                    <li><a>Tinggi Badan : 167 Cm</a></li>
                                    <li><a>Berat Badan : 70 Kg</a></li>
									<li><a>Bekerja : Rumah Sakit Barokah Jogja</a></li>
									<li><a>Alamat : Jl. Tamrin no : 31</a></li>
                                    <li><a>Pekerjaan : Dokter</a></li>
                                    <li><a>Instagram : @Anita_Natiur_P</a></li>
