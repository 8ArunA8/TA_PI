   ...
   <div class="main-textgrids">
				 		<div class="container">
				 			<div class="col-md-5 ab-pic">
				 					<img src="images/1dkr.jpg" alt=" " />

				 			</div>
				 			<div class="col_1_of_2">
				  <h4 class="text-blue title-border mb-30 bars">Biodata Dokter</h4>
								<ul class="ab">
									<li><a>Nama : Anthony Jayaprana</a></li>
                                    <li><a>Tanggal Lahir : 12 Januari 1981</a></li>
                                    <li><a>Tinggi Badan : 173 Cm</a></li>
                                    <li><a>Berat Badan : 60 Kg</a></li>
									<li><a>Bekerja : Rumah Sakit Al Amin Semarang</a></li>
									<li><a>Alamat : Jl. Diponegoro no : 34</a></li>
                                    <li><a>Pekerjaan : Dokter</a></li>
                                    <li><a>Instagram : @Anthony_J</a></li>
