   ...
   <div class="main-textgrids">
				 		<div class="container">
				 			<div class="col-md-5 ab-pic">
				 					<img src="images/9dkr.jpg" alt=" " />

				 			</div>
				 			<div class="col_1_of_2">
				  <h4 class="text-blue title-border mb-30 bars">Biodata Dokter</h4>
								<ul class="ab">
									<li><a>Nama : Cindy Annathasshia</a></li>
                                    <li><a>Tanggal Lahir : 23 Januari 1973</a></li>
                                    <li><a>Tinggi Badan : 166 Cm</a></li>
                                    <li><a>Berat Badan : 70 Kg</a></li>
									<li><a>Bekerja : Rumah Sakit Maju Jaya Semarang</a></li>
									<li><a>Alamat : Jl. Dipihno no : 34</a></li>
                                    <li><a>Pekerjaan : Dokter</a></li>
                                    <li><a>Instagram : @Cindy_Annathasshia</a></li>
