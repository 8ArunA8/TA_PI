   ...
   <div class="main-textgrids">
				 		<div class="container">
				 			<div class="col-md-5 ab-pic">
				 					<img src="images/5dkr.jpg" alt=" " />

				 			</div>
				 			<div class="col_1_of_2">
				  <h4 class="text-blue title-border mb-30 bars">Biodata Dokter</h4>
								<ul class="ab">
									<li><a>Nama : Astri Novita</a></li>
                                    <li><a>Tanggal Lahir : 1 Juni 1970</a></li>
                                    <li><a>Tinggi Badan : 169 Cm</a></li>
                                    <li><a>Berat Badan : 69 Kg</a></li>
									<li><a>Bekerja : Rumah Sakit Kalijaga Demak</a></li>
									<li><a>Alamat : Jl. Pakubuono no : 4</a></li>
                                    <li><a>Pekerjaan : Dokter</a></li>
                                    <li><a>Instagram : @Astri_Novita</a></li>
