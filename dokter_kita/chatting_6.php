   ...
   <div class="main-textgrids">
				 		<div class="container">
				 			<div class="col-md-5 ab-pic">
				 					<img src="images/6dkr.jpg" alt=" " />

				 			</div>
				 			<div class="col_1_of_2">
				  <h4 class="text-blue title-border mb-30 bars">Biodata Dokter</h4>
								<ul class="ab">
									<li><a>Nama : Budi Irawan</a></li>
                                    <li><a>Tanggal Lahir : 12 Januari 1971</a></li>
                                    <li><a>Tinggi Badan : 163 Cm</a></li>
                                    <li><a>Berat Badan : 70 Kg</a></li>
									<li><a>Bekerja : Rumah Sakit Bakti Ibu Semarang</a></li>
									<li><a>Alamat : Jl. Suliman no : 31</a></li>
                                    <li><a>Pekerjaan : Dokter</a></li>
                                    <li><a>Instagram : @Budi_Irawan</a></li>
