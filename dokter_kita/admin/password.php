...
<body>
	...
	<div class="container">
		<div class="content">
			<h2>Data User &raquo; Ganti Password</h2>
			<hr />
			
			<p>Ganti password Users dengan ID <?php echo '<b>'.$_GET['nik'].'</b>'; ?></p>
			...
			if(isset($_POST['ganti'])){
				...
				$cek = mysqli_query($koneksi, "SELECT * FROM tbl_users WHERE nik='$nik' AND password='$password'");
				if(mysqli_num_rows($cek) == 0){
					...
					if($password1 == $password2){
						if(strlen($password1) >= 6){
							$pass = md5($password1);
							$update = mysqli_query($koneksi, "UPDATE tbl_users SET password='$pass' WHERE nik='$nik'");
							if($update){
