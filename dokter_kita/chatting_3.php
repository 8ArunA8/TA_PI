   ...
   <div class="main-textgrids">
				 		<div class="container">
				 			<div class="col-md-5 ab-pic">
				 					<img src="images/3dkr.jpg" alt=" " />

				 			</div>
				 			<div class="col_1_of_2">
				  <h4 class="text-blue title-border mb-30 bars">Biodata Dokter</h4>
								<ul class="ab">
									<li><a>Nama : Bagus Baruna</a></li>
                                    <li><a>Tanggal Lahir : 10 April 1975</a></li>
                                    <li><a>Tinggi Badan : 165 Cm</a></li>
                                    <li><a>Berat Badan :71 Kg</a></li>
									<li><a>Bekerja : Rumah Sakit Ceria Jombang</a></li>
									<li><a>Alamat : Jl. Sukarno no : 14</a></li>
                                    <li><a>Pekerjaan : Dokter</a></li>
                                    <li><a>Instagram : @Bagus_Baruna</a></li>
