   ...
   <div class="main-textgrids">
				 		<div class="container">
				 			<div class="col-md-5 ab-pic">
				 					<img src="images/7dkr.jpg" alt=" " />

				 			</div>
				 			<div class="col_1_of_2">
				  <h4 class="text-blue title-border mb-30 bars">Biodata Dokter</h4>
								<ul class="ab">
									<li><a>Nama : Bhakti Surya Lesmana</a></li>
                                    <li><a>Tanggal Lahir : 2 Juli 1972</a></li>
                                    <li><a>Tinggi Badan : 168 Cm</a></li>
                                    <li><a>Berat Badan : 60 Kg</a></li>
									<li><a>Bekerja : Rumah Sakit Mutakhin Solo</a></li>
									<li><a>Alamat : Jl. Solobaru no : 34</a></li>
                                    <li><a>Pekerjaan : Dokter</a></li>
                                    <li><a>Instagram : @Bhakti_Surya_L</a></li>
