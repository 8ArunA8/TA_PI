   ...
   <div class="main-textgrids">
				 		<div class="container">
				 			<div class="col-md-5 ab-pic">
				 					<img src="images/4dkr.jpg" alt=" " />

				 			</div>
				 			<div class="col_1_of_2">
				  <h4 class="text-blue title-border mb-30 bars">Biodata Dokter</h4>
								<ul class="ab">
									<li><a>Nama : Azizah Mahzan</a></li>
                                    <li><a>Tanggal Lahir : 14 Februari 1982</a></li>
                                    <li><a>Tinggi Badan : 166 Cm</a></li>
                                    <li><a>Berat Badan : 66 Kg</a></li>
									<li><a>Bekerja : Rumah Sakit Kasih Ibu Jogja</a></li>
									<li><a>Alamat : Jl. Ahmadyani no : 34</a></li>
                                    <li><a>Pekerjaan : Dokter</a></li>
                                    <li><a>Instagram : @Azizah_Mahzan</a></li>
